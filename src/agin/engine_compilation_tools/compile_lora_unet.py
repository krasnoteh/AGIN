...
from diffusers import UNet2DConditionModel, StableDiffusionXLPipeline, EulerDiscreteScheduler, AutoencoderKL, AutoencoderTiny, ControlNetModel
from diffusers import StableDiffusionXLPipeline, UNet2DConditionModel, EulerDiscreteScheduler, StableDiffusionXLControlNetPipeline
...
unet.use_force_attention = use_force_attention

# Step 1.1: patch unet with lora
...
text_encoder = CLIPTextModel.from_pretrained(
    config.path_to_models / "text_encoder"
).to("cuda", torch.float16)
text_encoder_2 = CLIPTextModelWithProjection.from_pretrained(
    config.path_to_models / "text_encoder_2"
).to("cuda", torch.float16)
...
scheduler = EulerAncestralDiscreteScheduler.from_pretrained(
    config.path_to_models / "scheduler_turbo"
)
